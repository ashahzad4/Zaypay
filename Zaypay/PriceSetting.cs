...
namespace Zaypay
{
    public class PriceSetting
    {
        ...
        public PriceSetting(int pId = 0, string pKey = null)
        {
            ...
            if (pId != 0 && pKey != null)
            {
                System.Diagnostics.Debug.WriteLine("GOT BOTH VALUES");
                ID = pId;
                KEY = pKey;
            }
            else
        ...
        public virtual Hashtable GetResponse(string url, string method = "GET", string parameters = "")
        {
            ...
            try
            {
                ...
                Console.WriteLine("in the get response : " + parameters);
        ...
        {
            Console.WriteLine("all set" + !String.IsNullOrEmpty(LOCALE));
        ...
        public static void Main()
        {
            ...
            Console.WriteLine(ps.id + " and " + ps.key);
            ps.locale = "en-NL";
