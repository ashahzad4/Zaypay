...
namespace Zaypay.WebService
{
    public class PaymentResponse : Response
    {
        ...
        public Hashtable Instructions()
        {
            ...
            //ins["short_instructions"] = response["short-instructions"];
            //ins["long_instructions"] = response["long-instructions"];
            //ins["very_short_instructions"] = response["very-short-instructions"];
            //ins["very_short_instructions_with_amount"] =  response["very-short-instructions-with-amount"];
            return ins;
        }
        ...
        {
            Console.WriteLine("it contains or not: " + ((Hashtable)response["payment"]).ContainsKey("verification-needed"));
